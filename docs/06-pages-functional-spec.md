...
- **Form (RHF + Zod, `schemas/checkout.schema.js`):** customer_name, phone (required, validated format), email (optional, validated format if provided), address_line, city, notes (optional).
