export default {
  ...
  "common.home.heroCtaStory": "Our Story",
  ...
  "auth.forgot.identifier": "Phone number or email",
  "auth.forgot.identifierSubtitle":
    "Enter your phone number or email — we'll send a 6-digit code to your account's email address.",
  "auth.forgot.invalidIdentifier": "Enter a valid phone number or email",
  "auth.forgot.sendCode": "Send code",
  "auth.forgot.codeSubtitle": "Check your email for the code we sent.",
  "auth.forgot.codeSentIntro": "We sent a 6-digit code to",
  "auth.forgot.useLatestCode": "Use the code from the newest email — older codes stop working.",
  "auth.forgot.resending": "Sending…",
  "auth.forgot.resendIn": "Resend code in {{seconds}}s",
  "auth.forgot.emailSendFailed":
    "We couldn't send the email right now. Please try again in a moment.",
  "auth.forgot.stepIdentifier": "Account",
  "auth.forgot.stepCode": "Verify",
  "auth.forgot.stepPassword": "New password",
  "auth.forgot.codeLabel": "Verification code",
  "auth.forgot.verify": "Verify code",
  "auth.forgot.resend": "Didn't receive it? Resend code",
  "auth.forgot.resent": "A new code has been sent to your email.",
  "auth.forgot.newPasswordSubtitle": "Choose a new password for your account.",
