export default {
  ...
  "auth.forgot.identifier": "رقم الهاتف أو البريد الإلكتروني",
  "auth.forgot.identifierSubtitle":
    "أدخل رقم هاتفك أو بريدك الإلكتروني — سنرسل رمزًا مكوّنًا من 6 أرقام إلى البريد الإلكتروني المسجّل في حسابك.",
  "auth.forgot.invalidIdentifier": "أدخل رقم هاتف أو بريداً إلكترونياً صحيحاً",
  "auth.forgot.sendCode": "إرسال الرمز",
  "auth.forgot.codeSubtitle": "تحقق من بريدك الإلكتروني لإيجاد الرمز الذي أرسلناه.",
  "auth.forgot.codeSentIntro": "أرسلنا رمزًا مكوّنًا من 6 أرقام إلى",
  "auth.forgot.useLatestCode": "استخدم الرمز من أحدث رسالة — الرموز الأقدم تتوقف عن العمل.",
  "auth.forgot.resending": "جارٍ الإرسال…",
  "auth.forgot.resendIn": "إعادة الإرسال بعد {{seconds}} ثانية",
  "auth.forgot.emailSendFailed":
    "لم نتمكن من إرسال البريد الإلكتروني الآن. يرجى المحاولة بعد قليل.",
  "auth.forgot.stepIdentifier": "الحساب",
  "auth.forgot.stepCode": "التحقق",
  "auth.forgot.stepPassword": "كلمة مرور جديدة",
  "auth.forgot.codeLabel": "رمز التحقق",
  "auth.forgot.verify": "تأكيد الرمز",
  "auth.forgot.resend": "لم يصلك الرمز؟ أعد الإرسال",
  "auth.forgot.resent": "تم إرسال رمز جديد إلى بريدك الإلكتروني.",
  "auth.forgot.newPasswordSubtitle": "اختر كلمة مرور جديدة لحسابك.",
  "auth.forgot.newPassword": "كلمة المرور الجديدة",
  "auth.forgot.updatePassword": "تحديث كلمة المرور",
  "auth.forgot.doneTitle": "تم تحديث كلمة المرور!",
  "auth.forgot.doneBody":
    "يمكنك الآن تسجيل الدخول بكلمة المرور الجديدة.",
  "auth.forgot.backToLogin": "العودة لتسجيل الدخول",
  "auth.forgot.invalidCode": "الرمز غير صحيح أو منتهي الصلاحية",
  "auth.forgot.codeLocked":
    "محاولات خاطئة كثيرة جدًا. اطلب رمزًا جديدًا وحاول مرة أخرى.",
